let memoryWall = [
    ...
    deceasedsInfo: [
      {
        ...
        imgPath: "http://localhost:3000/uploads/face1.jpg",
      },
      {
        id: 2,
        name: "אלברט אינשטיין",
        donationAmount: 150000,
        imgPath: "http://localhost:3000/uploads/face2.jpg",
      },
      {
        id: 3,
        name: "לאון יאן",
        donationAmount: 700000,
        imgPath: "http://localhost:3000/uploads/face3.jpg",
      },
      {
        id: 4,
        name: "רחל אייזנבך",
      ...
      },
      {
        ...
        imgPath: "http://localhost:3000/uploads/face5.jpg",
      },
      {
        id: 6,
        name: "רות חזן",
        donationAmount: 70000,
        imgPath: "http://localhost:3000/uploads/face6.jpg",
      },
      {
        id: 7,
        name: "רונן שמואלי",
        donationAmount: 900000,
        imgPath: "http://localhost:3000/uploads/face7.jpg",
      },
      {
        id: 8,
        name: "יונתן קלדרון",
        donationAmount: 300000,
        imgPath: "http://localhost:3000/uploads/face8.jpg",
      },
      {
        id: 9,
        name: "אילנה דויד",
        donationAmount: 250000,
        imgPath: "http://localhost:3000/uploads/face9.jpg",
      },
      {
        id: 10,
        name: "דויד גרוסמן",
        donationAmount: 800000,
        imgPath: "http://localhost:3000/uploads/face10.jpg",
      },
    ],
    highlightsNews: [
      {
      ...
      {
        id: "2",
        img: "https://jerusalem.mynet.co.il/picserver/mynet/wcm_upload/wcm_mynet_pic/crop_images/2020/02/16/446557/511005_0_0_1059_603_large.jpg",
      ...
      {
        id: "3",
        img: "https://pic1.calcalist.co.il/PicServer3/2020/10/21/1029474/1-l.jpg",
        date: "2022-03-03",
        text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed nonne merninisti licere mihi ista probare, quae sunt a te dicta? Refert tamen, quo modo.",
        title: "נפתח אגף יולדות שברנו שיא עם לידת 380 תינוקות ביום",
      },
  ...
  },
  {
    ...
    about: `
    מלחמת יום הכיפורים פרצה ביום הכיפורים י' בתשרי ה'תשל"ד, 6 באוקטובר 1973,
     בהתקפת קואליציה של צבאות מדינות ערביות נגד ישראל, בהובלתן של סוריה ומצרים
    , שנתמכו על ידי חילות משלוח מארצות ערב, בעיקר מעיראק ומירדן. המלחמה התרחשה בעיקר בסיני וברמת הגולן
    . ונמשכה עד כ"ח בתשרי ה'תשל"ד, 24 באוקטובר 1973, יום כניסת הפסקת האש לתוקף.
       `,
    ratingTypes: {
    ...
    sliderUpdates: [
      ...
      },
      {
        id: "4",
        imagePath:
          "https://upload.wikimedia.org/wikipedia/commons/9/92/Yom_Kippur_War._VI.jpg",
        text: "תותח מתנייע M-50 בזמן ירי בסיני",
      },
      {
        id: "5",
        imagePath:
